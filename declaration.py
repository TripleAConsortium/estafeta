        ...
        <body>
            <div class="form-container">
                ...
                <div class="button-group">
                    ...
                    <button class="twitch-button" onclick="openTwitchAdmin()">Twitch Admin Panel</button>
                </div>
            </div>
            ...
            <script>
                ...
                function openTwitchAdmin() {{
                    window.location.href = '/twitch_admin';
                }}
